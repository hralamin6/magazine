<header class="h-16 bg-white/90 dark:bg-gray-800/90 backdrop-blur border-b border-gray-200 dark:border-gray-700 flex items-center px-2 sticky top-0 z-20">
    <div class="flex items-center justify-between w-full space-x-3">
        ...
        <div class="relative flex-1 max-w-xl">
            ...
            <input type="text" placeholder="Search people, chats, or groups" class="w-full pl-10 pr-4 py-2 rounded-full bg-gray-100 dark:bg-gray-700 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 dark:placeholder-gray-400" />
        </div>
                ...
                <div x-data="{open:false}" class="relative">
                    ...
                    <div x-cloak x-show="open" @click.outside="open=false" x-transition.origin.top.right class="absolute right-0 mt-2 w-48 bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700 overflow-hidden">
                        <div class="px-4 py-3 border-b border-gray-100 dark:border-gray-700 text-sm">
                            ...
                            <p class="text-xs text-gray-500 dark:text-gray-400">alex@example.com</p>
                        </div>
                        <ul class="py-1 text-sm">
                            <li><a href="#" class="flex items-center px-4 py-2 hover:bg-gray-50 dark:hover:bg-gray-700"><i class='bx bx-user mr-2'></i>Profile</a></li>
                            <li><a href="#" class="flex items-center px-4 py-2 hover:bg-gray-50 dark:hover:bg-gray-700"><i class='bx bx-customize mr-2'></i>Preferences</a></li>
                        </ul>
                        <button class="w-full flex items-center px-4 py-2 text-left text-red-500 hover:bg-red-50 dark:hover:bg-red-500/10 text-sm"><i class='bx bx-log-out mr-2'></i>Logout</button>
                    </div>
                </div>
            @endauth
            @guest
